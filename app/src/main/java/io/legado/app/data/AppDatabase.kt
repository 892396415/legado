...
import io.legado.app.data.dao.ReadingRecordDao
...
@Database(
    ...
    entities = [Book::class, BookGroup::class, BookSource::class, BookChapter::class,
        ...
        RssStar::class, TxtTocRule::class, ReadRecord::class, ReadingRecord::class, HttpTTS::class, Cache::class,
...
abstract class AppDatabase : RoomDatabase() {
    ...
    abstract val readingRecordDao: ReadingRecordDao
